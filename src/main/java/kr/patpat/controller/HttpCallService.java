...
public class HttpCallService {
	 ...
	 *
	 * @ param Map<String,String> header HttpHeader 정보 @ param Object params
	 * HttpBody 정보 @ return HttpEntity 생성된 HttpClient객체 정보 반환 @ exception 예외사항
	 */
	 ...
	 * Http 요청 method
	 *
	 * @ param String url 요청 URL 정보 @ param HttpMethod method 요청 Method 정보 @ param
	 * HttpEntity<?> entity 요청 EntityClient 객체 정보 @ return HttpEntity 생성된
	 * HttpClient객체 정보 반환
	 */
	 ...
	 * Http 요청 method
	 *
	 * @ param URI url 요청 URL 정보 @ param HttpMethod method 요청 Method 정보 @ param
	 * HttpEntity<?> entity 요청 EntityClient 객체 정보 @ return HttpEntity 생성된
	 * HttpClient객체 정보 반환
	 */
